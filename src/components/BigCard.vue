          ...
          <div class="w-100 bg-transparent  d-flex flex-row justify-content-between align-items-center p-2 my-0 "
            ...
            <div class="card">
              ...
              <div class="image box-image">
                <img v-if="store.selectedCharacter.image" :src="store.imgPath + store.selectedCharacter.image"
                  :alt="store.selectedCharacter.name">
                <svg v-else viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="svg">
                  <path
              ...
              <div class="category flex-wrap">
                ...
                <button class="button" v-if="store.selectedCharacter.attack">ATTACK:&nbsp; {{
                  store.selectedCharacter.attack }}</button>
                <button class="button" v-if="store.selectedCharacter.defence">DEFENCE:&nbsp; {{
                  store.selectedCharacter.defence }}</button>
                <button class="button" v-if="store.selectedCharacter.speed">SPEED:&nbsp;
                  {{ store.selectedCharacter.speed }}</button>
              </div>
            ...
            <div class="card">
              ...
              <div class="rectangle right-bottom"></div>
              <div class="image">
                <img v-if="store.selectedItem.image" :src="store.imgPath + store.selectedItem.image"
                  :alt="store.selectedItem.name">
                <svg v-else viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="svg">
                  <path
                    d="M20 5H4V19L13.2923 9.70649C13.6828 9.31595 14.3159 9.31591 14.7065 9.70641L20 15.0104V5ZM2 3.9934C2 3.44476 2.45531 3 2.9918 3H21.0082C21.556 3 22 3.44495 22 3.9934V20.0066C22 20.5552 21.5447 21 21.0082 21H2.9918C2.44405 21 2 20.5551 2 20.0066V3.9934ZM8 11C6.89543 11 6 10.1046 6 9C6 7.89543 6.89543 7 8 7C9.10457 7 10 7.89543 10 9C10 10.1046 9.10457 11 8 11Z">
                  </path>
            ...
            <div class="card">
              ...
              <div class="rectangle right-bottom"></div>
              <div class="image box-image">
                <img v-if="store.selectedType.image" :src="store.imgPath + store.selectedType.image"
                  :alt="store.selectedType.name">
                <svg v-else viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="svg">
                  <path
                    d="M20 5H4V19L13.2923 9.70649C13.6828 9.31595 14.3159 9.31591 14.7065 9.70641L20 15.0104V5ZM2 3.9934C2 3.44476 2.45531 3 2.9918 3H21.0082C21.556 3 22 3.44495 22 3.9934V20.0066C22 20.5552 21.5447 21 21.0082 21H2.9918C2.44405 21 2 20.5551 2 20.0066V3.9934ZM8 11C6.89543 11 6 10.1046 6 9C6 7.89543 6.89543 7 8 7C9.10457 7 10 7.89543 10 9C10 10.1046 9.10457 11 8 11Z">
                  </path>
