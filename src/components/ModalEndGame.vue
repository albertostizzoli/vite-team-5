<template>
    <div class="modal fade z-ind-high " id="endagame" tabindex="-1" aria-labelledby="endagameLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div v-if="vittoria" class="modal-body text-white">
                    Congratulation, YOU WIN!!!!!! You are the strongest!
                </div>
                <div v-else class="modal-body text-white">
                    YOU LOSE!!!!!
                </div>
                <div>
                    <router-link :to="{ name: 'home' }" class="btn btn-primary" data-bs-dismiss="modal">Chose you
        ...
        <section v-if="store.showModal" class="z-ind-high mt-5 me-5">
            <div v-show="store.closePopUp" class="code-editor floating border">
                <div class="header">
                    ...
                    <svg @click="store.closePopUp = !store.closePopUp" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <div class="editor-content d-flex justify-content-between mt-3">
                    <p @click="store.closePopUp = !store.closePopUp">
                        No!
                    </p>
                    <p @click="confirmBack">
                        <router-link :to="{ name: 'home' }" class="fw-bold nav-link d-inline border-bottom">
                            Si!
                        </router-link>
                    </p>
                </div>
